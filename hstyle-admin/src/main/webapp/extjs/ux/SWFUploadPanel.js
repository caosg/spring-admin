...
Ext.define('Ext.ux.SWFUploadPanel',{
	...
	flash9_url : "resources/swfupload/swfupload_fp9.swf",
	...
	upload_start_handler : function(file){
		...
		this.addPostParam('fileName',rec.get('fileName'));
	...
	upload_success_handler : function(file, serverData, responseReceived){
		...
		//console.log('file name:'+file.name+' is uploading successful');
	},
