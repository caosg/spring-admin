/**
 * @class Ext.view.porta.PortalPanel
 * @extends Ext.panel.Panel
 * A {@link Ext.panel.Panel Panel} class used for providing drag-drop-enabled portal layouts.
 */
Ext.define('AM.view.portal.PortalPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.portalpanel',

    requires: ['AM.view.portal.PortalColumn'],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('AM.view.portal.PortalDropZone', this, this.dropConfig);
    },
